		...
		<div class="profile-wrapper">
			...
			<div class="profile">
				...
				<div class="profile-user-settings">
					...
					<h1 class="profile-user-name"><?php echo check_username($myuserid); ?></h1>

					<button class="profile-btn profile-edit-profile-btn">Edit Profile</button>

					<button class="profile-btn profile-settings-profile-btn" aria-label="profile settings"><i class="fas fa-cog" aria-hidden="true"></i></button>
